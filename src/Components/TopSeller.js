...
const TopSeller = [
  { id : 1, seller_name : 'Jane Copper', username : '@jane', imgSrc : Seller1},
  { id : 2, seller_name : 'Ariene Macooy', username : '@ariene', imgSrc : Seller2},
  { id : 3, seller_name : 'Theresa Webb', username : '@theresa', imgSrc : Seller3},
  { id : 4, seller_name : 'Raplh edwards', username : '@ralph', imgSrc : Seller4},
